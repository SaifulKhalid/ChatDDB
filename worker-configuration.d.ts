/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: c7e72146f7779a589d9d90692a3cea8d)
// Runtime types generated with workerd@1.20260722.1 2026-07-01 nodejs_compat
interface __BaseEnv_Env {
	AGENTROUTER_MODEL: "gpt-5.6-sol";
	AGENTROUTER_BASE_URL: "https://agentrouter.org/v1";
	AGENTROUTER_USER_AGENT: "claude-cli/2.1.158 (external, sdk-cli)";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AGENTROUTER_MODEL" | "AGENTROUTER_BASE_URL" | "AGENTROUTER_USER_AGENT" | "MAX_OUTPUT_TOKENS" | "UPSTREAM_TIMEOUT_MS" | "AGENTROUTER_API_KEY">> {}
}
